...
db %>% 
  filter(type_of_measure %in% c("cash transfer", "voucher")) %>% 
  select(type_of_measure, new_info_deliver, new_information_select, previous_info_deliver, previous_info_select) %>%
